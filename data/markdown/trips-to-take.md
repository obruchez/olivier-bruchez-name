...
* remote places, such as [Radisson](https://en.wikipedia.org/wiki/Radisson,_Quebec) in Quebec, [Happy Valley-Goose Bay](https://en.wikipedia.org/wiki/Happy_Valley-Goose_Bay) in Newfoundland and Labrador, etc.
* even remoter places, such as [Tuktoyaktuk](https://en.wikipedia.org/wiki/Tuktoyaktuk) in Northwest Territories, etc.
